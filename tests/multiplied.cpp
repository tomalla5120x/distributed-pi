//g++ -std=c++11 SocketBase.cpp SocketPassive.cpp SocketActive.cpp "../tests/multiplied.cpp" -o "../tests/multiplied"
//do użycia z Wiresharkiem do zaglądania głębiej do komunikacji
